...
class ComplaintManagementService:
    ...
    def create_complaint(
        ...
        Args:
            ...
            complaint_type: Type of complaint ('app' or 'delivery')
        ...
        try:
            ...
            if complaint_type not in valid_types:
                complaint_type = 'app'  # Default to 'app' if invalid
    ...
    def assign_complaint(
        ...
        Note: Assignment functionality has been removed. This method is kept for backward compatibility
        but no longer performs assignment operations.
        
        Args:
            user: The user assigning the complaint
            complaint_id: ID of the complaint
            assigned_to_id: ID of the staff member to assign to (ignored)
